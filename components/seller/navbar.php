<nav class="nav-container">
  ...
  <div  class="nav-link-container">
    <p class="nav-link">
      <a href="/onlycars/seller/new">Add New Car</a>
    </p>
    <p class="nav-link">
      <a href="/onlycars/seller/cars">Your Cars</a>
    </p>
    <div>
      <?php  
      if($authDetails["isLoggedIn"]) {
        echo "<div class='auth'>";
         ...
         echo "</div>";
          ...
          echo "<a href='/onlycars/seller/auth'>Sign In</a>";
        }  
      ?>
    </div>
  </div>
...
<script>
  ...
  if(logoutBtn){
    logoutBtn.addEventListener("click", () => {
      ...
      window.location.href = "http://localhost/onlycars/";  
    })
  }
</script>