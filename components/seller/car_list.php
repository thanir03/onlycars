        ...
        $car = $car_list[$i];
          echo "<div class='car-container'>";
            echo "<div class='car-details'>";
                ...
                echo "</div>";
                echo "<div class='car-minor-details'>";
                echo  sprintf("<p>Listed : %s </p>", $car->is_listed ?  "Yes" : "No");
                echo sprintf("<p>Sold : %s</p>",$car->is_sold ?  "Yes" : "No");
                echo "</div>";
                echo "</div>";
                ...
                echo "</div>";
                echo sprintf("<a href='%s' class='view-car-btn'>View Details</a>", '/onlycars/seller/id.php?id=' .  $car->car_id );
              echo "</div>";
      }
