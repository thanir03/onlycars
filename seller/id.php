...
<?php 
  ...
  if(array_key_exists("sellerToken", $_COOKIE)){
    $email = isSellerAuthenticated($conn, $userToken = $_COOKIE["sellerToken"] );
    if($email != null){
  ...
  $carDetails = getSellersCarById($conn, $id,  $authDetails["email"]);
  if(!isset($carDetails->car_id)){
    echo "<p>CAR DOES NOT EXIST</p> <a href='/onlycars/seller/cars'>Navigate to your cars</>";
    exit();
  }
...
<head>
  ...
  <link rel="stylesheet" href="/onlycars/styles/seller/id.css">
  <script src="/onlycars/script/seller/id.js" defer></script>
</head>
<body data-car_id=<?php echo $carDetails->car_id ?>>
  
  <nav class="nav-bar">

  <a href="/onlycars/seller/cars">
  ...
  <div class="seat-details">
    ...
    <?php if($carDetails->is_sold) echo "<p class='sold-car'>Car Has Been Sold</p>"; ?>
      ...
      <ul class="car-major-details">
        ...
        <?php 
          echo sprintf("<li>Listed : %s </li>", $carDetails->is_listed ? "Yes" : "No");
        ?>
        <?php 
          echo sprintf("<li>Sold : %s </li>", $carDetails->is_sold ? "Yes" : "No");
        ?>
        <?php
        if($carDetails->width){
      ...
      <button class="edit-car-btn" <?php if ($carDetails->is_sold) echo 'disabled'; ?>>
...
<g>
	<g>
      ...
      <button data-listed=<?php if($carDetails->is_listed) echo "true"; else echo "false";  ?> class="list-car-btn" <?php if ($carDetails->is_sold) echo 'disabled'; ?>><?php if($carDetails->is_listed) {echo "Unlist";} else echo  "List" ?> Car</button>
      </div>
      ...
      <div class="edit-container">
        ...
        <div class="edit-btn-container">
          <button class="update-btn">Update Car</button>
        </div>
      </div>
      </div>
